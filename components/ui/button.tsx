...
const buttonVariants = cva(
  ...
  justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold transition-all 
  ...
  aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive uppercase tracking-wide`,
  {
    variants: {
      variant: {
