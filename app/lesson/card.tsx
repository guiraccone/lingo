    ...
    return (
        <div
            ...
            className={cn(
                ...
                selected && status === "wrong" && "border-rose-300 bg-red-100 hover:bg-rose-100",
                disabled && "pointer-events-none hover:bg-white",
                type === "ASSIST" && "lg:p-3 w-full")
            }>
            {audio}
            {imageSrc && (
                <div className="relative aspect-square mb-4 max-h-20 lg:max-h-37.5">
                    <Image
